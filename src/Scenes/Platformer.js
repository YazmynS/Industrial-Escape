class End extends Phaser.Scene {
    ...
    preload(){
        ...
        //this.preload.scenePlugin("AnimatedTiles", "./lib/AnimatedTiles.js", "animatedTiles", "animatedTiles");
    }
...
// Handle collision detection
    ...
    update() {
        ...
        if (cursors.up.isDown && my.sprite.player.onRope) {
         ...
         // Player is on a Ladder, enable climbing
         if (my.sprite.player.onLadder) {
            ...
            // Stop climbing when no key is pressed
            else {
        ...
        //Door End Game
        if (my.sprite.player.onDoor && cursour.up.isDown)
        {
...
//Add Collisions
    //Ladders
        //Player shouldn't slide down ladder
...
//End level at the door
//Add behaviors to:
    //beams

//TA QUESTIONS
    //1. Why won't my door trigger work
    //2. Ladder Issues